...
class Game extends Component {
  ...
  possibleSolutions = ({numberOfStars, usedNumbers}) => {
    const possibleSolutions = lodash.range(1,10).filter(number => usedNumbers.indexOf(number) === -1);
    return possibleCombinationSum(possibleSolutions, numberOfStars)  
  }
  ...
  render() {
    ...
    return (
      <div className='container'>
        ...
        <br />
        {doneStatus ? <DoneFrame doneStatus={doneStatus} restartGame={this.restartGame}/>: <Numbers selectedNumbers={selectedNumbers}
